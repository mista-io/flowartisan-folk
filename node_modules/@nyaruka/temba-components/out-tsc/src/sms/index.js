...
export const splitSMS = function (message, options = {}) {
    const characterset = options && options.characterset;
    options = {
        summary: options && options.summary,
    };
    const isGsm = (characterset === undefined && validateMessage(message)) ||
        characterset === GSM;
    ...
    const remainingInPart = calculateRemaining(splitResult.parts, singleBytes, multiBytes, charBytes);
    return {
