 ...
 */
const isValidStart = (partialExpression, allowedTopLevels, allowIncomplete) => {
 ...
 */
const isInStringLiteral = (partialExpression) => {
...
export default class ExcellentParser {
     ...
     */
    constructor(expressionPrefix, allowedTopLevels) {
     ...
     */
    autoCompleteContext(partialExpression) {
     ...
     */
    functionContext(partialExpression) {
    ...
    findExpressions(text) {
        ...
        for (let pos = 0; pos < text.length; pos++) {
            ...
            if (state === STATE_BODY) {
                ...
                else if (ch === this.expressionPrefix &&
...
//# sourceMappingURL=ExcellentParser.js.map